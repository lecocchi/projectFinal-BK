...
DROP TABLE IF EXISTS tesis.user;
CREATE TABLE tesis.user(
  id integer not null auto_increment,
  avatar varchar(255),
  created_at datetime not null,
  dni integer,
...
INSERT INTO tesis.user
(avatar, created_at, dni, email, enabled, first_name, is_network, last_name, password, id_rol, updated_at, user_name)
VALUES
(null,'2019-02-17 20:31:22','12345678','admin',true,'admin',false,'admin','admin',3,'2019-02-17 20:31:22','admin');
