...
public class DailyMapper {
    ...
    public static Daily to(DailyDTO dailyDTO){
        ...
        return new Daily(dailyDTO.getFirstName(), dailyDTO.getLastName(), dailyDTO.getUserName(), dailyDTO.getAvatar(), LocalDate.now(), items, dailyDTO.getSprint(), dailyDTO.getIdProject());
    }
